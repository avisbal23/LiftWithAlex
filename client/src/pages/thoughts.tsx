  ...
  return (
    <>
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="space-y-4">
          {thoughts.length === 0 ? (
            <Card className="p-8 text-center backdrop-blur-md bg-white/20 dark:bg-gray-800/20 border border-white/30 dark:border-gray-600/30 shadow-xl rounded-2xl drop-shadow-[0_0_8px_rgba(255,255,255,0.15)]">
            ...
            thoughts.map((thought) => (
              <Card key={thought.id} className="backdrop-blur-md bg-white/25 dark:bg-gray-800/25 border border-white/30 dark:border-gray-600/30 shadow-xl hover:shadow-2xl hover:bg-white/35 dark:hover:bg-gray-800/35 transition-all duration-300 rounded-2xl overflow-hidden drop-shadow-[0_0_8px_rgba(255,255,255,0.15)] hover:drop-shadow-[0_0_12px_rgba(255,255,255,0.25)]">
